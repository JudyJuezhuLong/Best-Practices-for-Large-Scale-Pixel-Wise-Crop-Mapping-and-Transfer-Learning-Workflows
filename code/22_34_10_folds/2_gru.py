...
def main(args: argparse.Namespace):
    ...
    # Select 200,000 samples randomly from the dataset
    sample_size = 250000
    ...
    for fold_i in range(n_folds): 
        ...
        sample_size='250k'
        batch_size=int(pow(2, 12))
        x_train, x_val, y_train, y_val = train_test_split(x_train_val, y_train_val, stratify= y_train_val, test_size=10000, train_size=200000, random_state=17)
        """
