...
for fold_i in range(n_folds): 
    ...
    save_to_pkl(sc, os.path.join(f'./output_Judy_{fold_i}', f"{yy}_{preprocessing_method}_{model_type}_{sample_size}_scaler.pkl"))
    ...
    os.makedirs(f'./output_Judy_{fold_i}', exist_ok=True)
    save_to_pth_rf(rf, os.path.join(f'./output_Judy_{fold_i}', f"{yy}_{preprocessing_method}_{model_type}_{sample_size}_best.pth"))
