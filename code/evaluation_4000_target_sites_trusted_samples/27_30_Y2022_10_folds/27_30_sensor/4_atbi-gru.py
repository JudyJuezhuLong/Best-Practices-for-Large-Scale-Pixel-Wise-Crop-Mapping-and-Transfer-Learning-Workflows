...
def main(args: argparse.Namespace):
    ...
    x_dir_key = 'x_data_dir_'+target_scene_id+'_'+preprocessing_method+'_'+yy+'_'+product_name
    y_dir_key = 'y_data_dir_'+target_scene_id+'_'+preprocessing_method+'_'+yy+'_'+product_name
