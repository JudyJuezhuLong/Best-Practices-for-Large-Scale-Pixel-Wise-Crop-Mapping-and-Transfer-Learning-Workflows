...
source_scene_id = '27_30'
target_scene_id = '27_30'
...
# print(parent_l1_directory + current_directory[len(parent_l2_directory):len(parent_l3_directory)])
#%%
best_models_directory1 = parent_l1_directory + current_directory[len(parent_l2_directory):len(parent_l3_directory)]
best_models_directory1
#%%
...
def main(args: argparse.Namespace):
    ...
    for fold_i in range(n_folds): 
        ...
        PATH = os.path.join(f'{best_models_directory1}/output_Anonymous_{fold_i}', f"{source_yy}_{preprocessing_method}_{sample_size}_scaler.pkl")
        ...
        checkpoint_path = os.path.join(f'{best_models_directory1}/output_Anonymous_{fold_i}', f"{source_yy}_{preprocessing_method}_{model_type}_{sample_size}_best.pth")
        try:
