...
def pred_map(row):
    # ts_stamp = ts_stamp_ls[0]
    # x_test = np.load('/data/Anonymous/Anonymousfile/compare_semantic_vs_pixel/pixel_level_target_2016/'+ts_stamp+'_X.npy')
    # print(x_test.shape)
    # stamp1,stamp2 = ts_stamp.split('_')
    ts_stamp = row['tif_loc']
