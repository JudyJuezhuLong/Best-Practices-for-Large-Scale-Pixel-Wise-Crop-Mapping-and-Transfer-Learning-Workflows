...
class GRU(nn.Module):
    def __init__(self, input_feature_size, hidden_size, num_layers,
        ...
        self.decoder = nn.Linear(hidden_size * num_directions * 7, num_classes, bias=True)
...
def main(args: argparse.Namespace):
    def build_model(input_feature_size,num_classes,hidden_size=256, num_layers=1,bidirectional=False, dropout=0):
        return GRU (
    ...
    for fold_i in range(n_folds): 
        ...
        device = torch.device("cuda:0")  # "cuda:0" refers to the first GPU. If you have multiple GPUs, you can use "cuda:1" for the second GPU, and so on.
