...
best_models_directory1 = '/mnt/mridata/Anonymouslong/best_practice_pixel/28_29_10_folds'
...
def main(args: argparse.Namespace):
    ...
    # x_data=np.load('/data/Anonymous/Anonymousfile/best_practice/data/sample_data/spatial_transfer_2023_US/8_'+scene_id+'site_7days_ln_sar_2023_X.npy')
    # y_data=np.load('/data/Anonymous/Anonymousfile/best_practice/data/sample_data/spatial_transfer_2023_US/8_'+scene_id+'site_7days_ln_sar_2023_y.npy').ravel()
    # x_data = x_data[:,16:39,0:6]
