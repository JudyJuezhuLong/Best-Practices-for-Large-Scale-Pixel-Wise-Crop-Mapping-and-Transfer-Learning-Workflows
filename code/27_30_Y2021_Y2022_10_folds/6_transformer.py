...
x_dir_key = 'x_data_dir_'+scene_id+'_'+preprocessing_method+'_'+yy1
y_dir_key = 'y_data_dir_'+scene_id+'_'+preprocessing_method+'_'+yy1
...
print("X_data shape",x_data1.shape)
